...
class KTS:
    ...
    def cpd_nonlin(self,K, ncp, lmin=1, lmax=100000, backtrack=True, verbose=True,
                  out_scatters=None):
    ...
    def cpd_auto(self,K, ncp, vmax, desc_rate=1, **kwargs):
        """Main interface
        ...
        """
        m = ncp
        (_, scores) = self.cpd_nonlin(K, m, backtrack=False, **kwargs)
        ...
        (cps, scores2) = self.cpd_nonlin(K, m_best, **kwargs)
